                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="page-item-title">
                              <h1 class="text-center texttransform-none">{{ __('team.title') }}</h1>
                          </div>
                      </div>
                  </div>
              </div>
                ...
                <div class="col-md-12 entry-content">
                    <article>
                        ...
                        <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_custom_1501762265855 vc_row-has-fill">
                            <p style="  text-align: center; ; padding:5px;padding-bottom:30px;justify-content: center">{{ __('team.contact') }}</p>
                                            ...
                                            <div class="portfolio-list portfolio-columns-4 portfolio-grid-layout-4 clearfix" id="portfolio-list-76440791">
                                                <div class="portfolio-item-block text-left portfolio-item-animation-1 slide-item desert events fish meat" data-item="1" data-name="Beef Brisket Poutine">
                                                    <div class="portfolio-item-block-inside">
                                                            <div class="portfolio-item-image" data-style="background-image: url(https://static.wixstatic.com/media/f36f88_8edf52ce90674bb6b5d07de89ddffdd4~mv2.jpg/v1/fit/w_878,h_799,q_90/f36f88_8edf52ce90674bb6b5d07de89ddffdd4~mv2.webp);"></div>
                                                ...
                                                <div class="portfolio-item-block text-left portfolio-item-animation-1 slide-item fish" data-item="3" data-name="Salmon Tartare">
                                                    <div class="portfolio-item-block-inside">
                                                        <a href="upload/brooke-lark.jpg" target="_self" rel="lightbox">
                                                            <div class="portfolio-item-image" data-style="background-image: url(https://static.wixstatic.com/media/f36f88_d212ee59d1c74df3a8932b3e83c2d8b8~mv2.jpg/v1/fit/w_878,h_799,q_90/f36f88_d212ee59d1c74df3a8932b3e83c2d8b8~mv2.webp);"></div>
                                                            <div class="portfolio-item-bg"></div>
                                                    ...
                                                    <div class="portfolio-item-block-inside">
                                                        <a href="upload/barmen-coctail.jpg" target="_self" rel="lightbox">
                                                            <div
                                                                ...
                                                                data-style="background-image: url(https://static.wixstatic.com/media/f36f88_974fcdf030894a408a46a7ec9d0ff11a~mv2.jpg/v1/fit/w_878,h_799,q_90/f36f88_974fcdf030894a408a46a7ec9d0ff11a~mv2.webp);"
                                                            ></div>
                                                            <div class="portfolio-item-bg"></div>
                                                ...
                                                <div class="portfolio-item-block text-left portfolio-item-animation-1 slide-item desert events meat" data-item="3" data-name="Tuna Salad">
                                                    <div class="portfolio-item-block-inside">
                                                        <a href="upload/food-plate.jpg" target="_self" rel="lightbox">
                                                            <div class="portfolio-item-image" data-style="background-image: url(https://static.wixstatic.com/media/f36f88_f325654d14c34eb99ce61bdb305383f8~mv2.jpg/v1/fit/w_878,h_799,q_90/f36f88_f325654d14c34eb99ce61bdb305383f8~mv2.webp);"></div>
                                                            <div class="portfolio-item-bg"></div>
