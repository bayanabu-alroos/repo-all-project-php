                                    ...
                                    <div class="wpb_text_column wpb_content_element">
                                        <div class="wpb_wrapper">
                                            ...
                                            <p style="text-align: left;">
                                                ...
                                                <a href="Info.Sarayirestaurant.eg@gmail.com">Info.Sarayirestaurant.eg@gmail.com</a><br />
                                                {{ __('contact.contact3') }}<br />
                                                <a href="n.mohamed@sarayiresturant.com">n.mohamed@sarayiresturant.com</a><br />
                                                ...
                                                <div class="quform-element">
                                                    <p>
                                                        ...
                                                        <span class="wpcf7-form-control-wrap your-name">
                                                            <input id="name" type="text" name="name" size="40" class="input1" aria-required="true" aria-invalid="false" placeholder="{{ __('contact.name') }}*"value="{{ old('name') }}">
                                                            @if ($errors->has('name'))
                                                ...
                                                <div class="quform-element">
                                                    <p>
                                                        ...
                                                        <span class="wpcf7-form-control-wrap your-email">
                                                            <input id="email" type="text" name="email" size="40" class="input1" aria-required="true" aria-invalid="false" value="{{ old('subject') }}" placeholder="{{ __('contact.email') }}*">
                                                ...
                                                <div class="quform-element">
                                                    <p>
                                                        ...
                                                        <span class="wpcf7-form-control-wrap your-message">
                                                            <textarea  id="message" name="message" cols="40" rows="10" class="input1" aria-invalid="false" placeholder="{{ __('contact.message') }}*">{{ old('message') }}</textarea>
                                                            
                                                            @if ($errors->has('message'))
                                                            <span class="text-danger" style="color:red;">{{ $errors->first('message') }}</span>
                                                            @endif
                                                    ...
                                                    <div class="quform-submit ">
                                                        <div class="quform-submit-inner">
                                                            <button type="submit" value="Submit" class="submit-button" style="margin-top:20px"><span>{{ __('contact.button') }}</span></button>
                                                        </div>
