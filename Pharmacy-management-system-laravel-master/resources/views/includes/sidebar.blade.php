	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				{{-- <li>
					<a href="http://127.0.0.1:8000/landing"><i class="fe fe-home"></i> <span>Landing</span></a>
				</li> --}}
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						@endcan
						@can('view-role')
						<li><a class="{{ Request::routeIs('roles') ? 'active' : '' }}" href="{{route('roles')}}">Roles/Permissions</a></li>
						@endcan
					</ul>
				</li>
				@endcan
